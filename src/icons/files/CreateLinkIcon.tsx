...
interface CreateLinkIconProps extends SVGProps<SVGSVGElement> {
	width?: number;
	height?: number;
	color?: string;
	strokeWidth?: number;
...
/**
 * A reusable SVG icon component for rendering a create link icon.
 *
 ...
 *
 * @returns {JSX.Element} A scalable vector graphic (SVG) element representing the create link icon.
 */
const CreateLinkIcon: FC<CreateLinkIconProps> = ({
	width = 24,
	height = 24,
	color = '#667085',
	strokeWidth = 2,
